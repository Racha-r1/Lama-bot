...
from config import api as twitter
    ...
    for protocol in new_data:
        ...
        if id not in old_data:
            ...
            try:
                ...
                print(f"⚠️ Could not send Tweet about {name}\n\n{err}")
...
if __name__ == "__main__":
    ...
    schedule.every(12).hours.do(protocols_checks)
    schedule.every(12).hours.do(tvl_checks)
